...
import Cave.entities.Enemy;
import Cave.entities.Entity;
import Cave.entities.Player;
import Cave.graphics.Spritesheet;
import Cave.graphics.UI;
import Cave.world.World;

public class Game extends Canvas implements Runnable,KeyListener,MouseListener{

	private static final long serialVersionUID = 1L;
	public static JFrame frame = new JFrame("Cave Escape");
	...
	public Game(double heal, int enemyLife, double enemySpeed){
		rand = new Random();
		addKeyListener(this);
		...
		spritesheet = new Spritesheet("/Cave/res/spritesheet.png");
		player = new Player(0,0,16,16,spritesheet.getSprite(32, 0,16,16));
		entities.add(player);
		world = new World("/Cave/res/level"+CUR_LEVEL+".png");
    ...
    public void startCave(){
    	Game game = new Game(heal, enemyLife, enemySpeed);
    	game.start();
    	frame.setVisible(true);
    	frame.requestFocus();
	}  
	public synchronized void start(){
		Game cave = new Game(heal, enemyLife, enemySpeed);
		thread = new Thread(cave);
		isRunning = true;
		thread.start();
	}
